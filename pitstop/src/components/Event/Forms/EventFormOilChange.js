...
class EventFormOilChange extends Component {
        ...
        return (
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    ...
                    eventOilAmount: Yup.number().required('Field for amount of oil is required.'),
                ...
                {({isSubmitting, touched, errors}) => (
                    ...
                    <Form>
                        ...
                        <div className="form__field field--half">
                            ...
                            <ErrorMessage name="eventCompany" render={msg => <div className="field-error">{msg}</div>}/>
                        </div>
                        <div className="form__field field--half">
...
export default EventFormOilChange
